  ...
  theme: {
    extend: {
      ...
      colors: {
        ...
        logoCursinho: "#E05C1A", // orange
        logoProjeto: "#5B3F9E", // purple
        logoAdmin: "#00A69C", // teal
        logoLinguagens: "#D61F69", // magenta
        logoNatureza: "#1B3A5C", // navy
        logoHumanas: "#3BAD5A", // green
        logoMatematica: "#7CB800", // lime
        logoEstudos: "#F0B400", // yellow
      },
      borderRadius: {
        lg: "var(--radius)",
    ...
    backgroundImage: {
      "custom-gradient":
        "linear-gradient(to right, #37D6B5, #8cc408, #8CC408, #FFE53C, #FF7600, #DA005A)",
      "right-gradient":
        "linear-gradient(to right, #FFFFFF, #FFFFFF, #0F9B2C, #0F9B2C)",
    },
  },
  plugins: [
