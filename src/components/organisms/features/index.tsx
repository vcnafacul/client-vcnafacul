...
function Features() {
    ...
    const [feature, setFeature] = useState<ItemCard | undefined>(features?.items[0].Home_Features_Item_id);
    ...
    return (
        <div className=" text-center  overflow-hidden flex items-center flex-col">
            ...
            <div className="md:grid md:grid-cols-12 md:mx-16 flex w-full m-0 flex-col items-center">
                <Selector align="vertial" changeItem={changeItem} tabItems={features?.items.map(item => (item.Home_Features_Item_id.title))}/>
