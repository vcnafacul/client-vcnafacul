...
export const conteudoSchema = yup.object({
  ...
  textoQuestao: yup
    ...
    .max(20000, "O texto da questão não pode ter mais de 20000 caracteres"),

  // Pergunta (opcional)
  pergunta: yup
    .string()
    .optional()
    .max(5000, "A pergunta não pode ter mais de 5000 caracteres"),
