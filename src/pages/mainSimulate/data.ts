...
const textLinguagens =
  "Esta prova contêm questões da área Linguagem, Código e suas Tecnologias";
const textNatureza =
  "Esta prova contêm questões da área Ciência da Natureza e suas Tecnologias";
const textHumanas =
  "Esta prova contêm questões da área Ciência Humanas e suas Tecnologias";
const textMatematica =
  "Esta prova contêm questões da área Matemática e suas Tecnologias";
const itemsEnem1 = [
  "90 Questões",
...
export const simulateData: ISimulateData = {
  ...
  subTitleBook:
    "Realize um simulado mais rapido contento apenas 45 questões de um das áreas do conhecimentro do ENEM.",
  simulateCardsBook: [
    {
      id: 1,
      tipo: TipoSimulados.Linguagens,
      subTitle: textLinguagens,
      icon: Linguagens,
      className: "border-marine",
      color: "bg-marine",
    },
    {
      id: 2,
      tipo: TipoSimulados.Natureza,
      subTitle: textNatureza,
      icon: Natureza,
    ...
    {
      id: 3,
      tipo: TipoSimulados.Humanas,
      subTitle: textHumanas,
      icon: Humanas,
    ...
    {
      id: 4,
      tipo: TipoSimulados.Matematica,
      subTitle: textMatematica,
      icon: Matematica,
  ...
  subTitleDay:
    "Realize um simulado contendo 90 questões assim como cada um dos dias do ENEM.",
  simulateCardsDay: [
    {
      id: 5,
      tipo: TipoSimulados.Enem1,
      item: itemsEnem1,
      icon: Linguagens,
      className: "border-green2",
      color: "bg-green2",
    },
    {
      id: 6,
      tipo: TipoSimulados.Enem2,
      item: itemsEnem2,
      icon: Natureza,
      className: "border-green2",
      color: "bg-green2",
