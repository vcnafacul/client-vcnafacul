        ...
        <>
                ...
                buttons={
                    <div className="flex gap-4 justify-center items-center flex-col sm:flex-row">
                        ...
                        <Button onClick={confirmQuestion} disabled={questionSelected.answered  === undefined} className="bg-lightGreen border-lightGreen w-44 hover:border-green2 hover:bg-green2 transition-all duration-300">Confirmar</Button>
                    </div>
                }
                />
            <FinishReport />
