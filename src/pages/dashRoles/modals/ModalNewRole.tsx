...
function ModalNewRole({handleClose} : ModalNewRoleProps) {
    ...
    return (
        <ModalTemplate>
            <div className="bg-white p-4 rounded grid grid-cols-2">
                ...
                {rolesArray.map(role => (
                    <div className="flex gap-2 items-center">
                        ...
                        <div><Toggle checked={valueRoles[role]} handleCheck={(check: boolean) => { setValueRoles({...valueRoles, [role]: check}) }} /></div>
                    </div>
                ))}
